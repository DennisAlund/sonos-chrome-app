        ...
        function deviceService() {
            ...
            that.getDeviceForMediaGroup = function (mediaGroup) {
                var devicesInGroup = devices.filter(function (device) {
                    return device.groupName === mediaGroup;
                });
            ...
            function onDevices(deviceData) {
                ...
                deviceData.forEach(function (device) {
                    ...
                    if (!mediaGroupMap.hasOwnProperty(device.groupName) && device.canPlayMusic) {
                        mediaGroups.push(device.groupName);
                        mediaGroupMap[device.groupName] = true;
                    }
                });
